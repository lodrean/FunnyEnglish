...
async function main() {
  ...
  await click(180, 140, 4000); // Topics
  await click(180, 110, 4000); // Video
  await click(180, 730, 4000); // Questions
  await click(180, 760, 4000); // Practice
  await shot('practice');
