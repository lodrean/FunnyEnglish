# Техническое Задание для Kimi 2.5: Дизайн и Макеты Admin Panel FunnyEnglish

## 1. Общая Информация о Проекте

### 1.1 Описание проекта
**FunnyEnglish Admin Panel** — это административная панель для управления образовательным приложением по изучению английского языка. Приложение включает систему тестов, категорий, пользователей, геймификацию (достижения, streaks, лидерборд).
...
- Логин: admin@funnyenglish.com / admin123
