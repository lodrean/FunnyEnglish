...
class PracticeSubmissionServiceTest {
    ...
    fun `createSubmission success - saves with status NEW and storage url`() {
        ...
        every { storageService.uploadFile(any(), "speaking/submissions/u_$userId") } returns
            "https://media.example.com/funnyenglish/speaking/submissions/u_$userId/abc.m4a"
        ...
        assertEquals("https://media.example.com/funnyenglish/speaking/submissions/u_$userId/abc.m4a", result.audioUrl)
