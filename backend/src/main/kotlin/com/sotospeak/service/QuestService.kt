...
class QuestService(
    ...
    private fun generateDailyQuests(userId: UUID): List<com.sotospeak.entity.Quest> {
        val quests = mutableListOf<com.sotospeak.entity.Quest>()
    ...
    private fun generateWeeklyQuests(userId: UUID): List<com.sotospeak.entity.Quest> {
        val quests = mutableListOf<com.sotospeak.entity.Quest>()
    ...
    private fun createQuest(
        ...
        rewardXp: Int,
        rewardGems: Int
    ): com.sotospeak.entity.Quest {
        return com.sotospeak.entity.Quest(
            id = UUID.randomUUID(),
            userId = userId,
            title = title,
...
private fun com.sotospeak.entity.Quest.toModel(): DailyQuest {
    return DailyQuest(
        id = this.id.toString(),
        title = this.title,
...
private fun com.sotospeak.entity.Quest.toWeeklyQuest(): WeeklyQuest {
    return WeeklyQuest(
        id = this.id.toString(),
        title = this.title,
        description = this.description,
