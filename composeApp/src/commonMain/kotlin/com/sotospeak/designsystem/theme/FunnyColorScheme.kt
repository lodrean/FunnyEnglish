...
import com.sotospeak.designsystem.tokens.*

/**
 * So to Speak Extended Color Scheme
 *
...
/**
 * CompositionLocal for the extended So to Speak color scheme.
 */
val LocalFunnyColorScheme = staticCompositionLocalOf { LightFunnyColorScheme }

/**
 * Extension property to access the extended So to Speak color scheme from MaterialTheme.
 */
