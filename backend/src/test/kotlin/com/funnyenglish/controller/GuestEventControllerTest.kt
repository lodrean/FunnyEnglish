...
class GuestEventControllerTest {
    ...
    fun `аналитика гостей считает агрегаты и конверсию`() {
        ...
        guestEventRepository.save(
            com.funnyenglish.entity.GuestEvent(anonymousId = guest1, type = GuestEventType.SESSION_STARTED)
        )
        guestEventRepository.save(
            com.funnyenglish.entity.GuestEvent(anonymousId = guest1, type = GuestEventType.TEST_COMPLETED, score = 5, maxScore = 10)
        )
        guestEventRepository.save(
            com.funnyenglish.entity.GuestEvent(anonymousId = guest2, type = GuestEventType.SESSION_STARTED)
        )
