# Delta spec: Light/dark theme toggle

**Target main specs:** `docs/DESIGN_SYSTEM_SPEC.md`, `docs/SPEAKING_TRAINER_SPEC_PART2.md`, `docs/SPEAKING_TRAINER_SPEC_PART3.md`
