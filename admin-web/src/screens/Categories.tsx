...
import { StatusBadge, InactiveBadge } from '@components/data';
  ...
  return (
    <Box>
      ...
      >
        ...
        <Box sx={{ color: category.isActive ? theme.palette.primary.main : theme.palette.text.secondary, mr: 1.5 }}>
        ...
        <Box flex={1}>
          <Typography variant="body1" fontWeight={500}>
            {category.name}
            {!category.isActive && (
              <InactiveBadge label="Inactive" size="small" sx={{ ml: 1, height: 20 }} />
            )}
          </Typography>
...
const Categories: React.FC = () => {
  ...
  const [, setParentIdForNew] = useState<string | null>(null);
      ...
      <Box>
        {isLoading ? (
          ...
          filteredCategories.map((category) => (
            ...
            >
              <FolderIcon sx={{ color: theme.palette.primary.main, mr: 1.5 }} />
              <Box flex={1}>
                <Typography variant="body1" fontWeight={500}>
                  {category.name}
                </Typography>
              ...
              <StatusBadge status="success" label={`${category.testCount} tests`} size="small" sx={{ mr: 2 }} />
            </Paper>
          ))
        ) : (
          // Tree view
