...
UI тесты So to Speak построены на **Compose UI Testing Framework** с использованием **Page Object Pattern**. Это позволяет писать читаемые тесты, которые моделируют реальные действия пользователя.
