                ...
                {question.options.map((option, idx) => (
                  <Box
                    ...
                    sx={{
                      ...
                      backgroundColor: colors.card,
                      borderRadius: '8px',
                      border: (question.correctAnswers as (string | number)[])?.includes(idx) ||
                        (question.correctAnswers as (string | number)[])?.includes(option)
                        ? `1px solid ${colors.success}`
                        : '1px solid transparent',
                    }}
                  >
                    {(question.correctAnswers as (string | number)[])?.includes(idx) ||
                      (question.correctAnswers as (string | number)[])?.includes(option) ? (
