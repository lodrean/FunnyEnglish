...
import com.sotospeak.shared.model.LeaderboardEntry
import com.sotospeak.shared.model.LevelUpInfo
...
import com.sotospeak.shared.model.XpData
import com.sotospeak.shared.model.XpGain
...
class XpService(
    ...
    private val userRepository: com.sotospeak.repository.UserRepository
) {
...
private fun XpHistory.toModel(): com.sotospeak.shared.model.XpGain {
    return com.sotospeak.shared.model.XpGain(
        amount = this.amount,
        source = com.sotospeak.shared.model.XpSource.valueOf(this.source),
