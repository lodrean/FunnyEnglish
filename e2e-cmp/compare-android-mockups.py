...
Источники:
  - мокапы:  e2e-cmp/test-results/pixel-report/mockups-light-phone/frame-*.png (360x800, рендер mockups.html v2.1)
  - приложение: docs/qa/design-conformance/android-2026-08-10/*.png (Maestro takeScreenshot, физ. устройство 1080x2408@440)

Перед сравнением у Android-скриншота обрезаются системные бары (статус-бар/навбар) — см. CROP_TOP_PX/CROP_BOTTOM_PX.
Результат: diff-overlays + summary.json в .../android-2026-08-10/diffs/.
"""
import json
...
APP = REPO / 'docs' / 'qa' / 'design-conformance' / 'android-2026-08-10'
OUT = APP / 'diffs'
