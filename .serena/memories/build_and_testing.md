# Сборка и тестирование So to Speak
...
- Base URL API: Android — property SOTOSPEAK_API_BASE_URL (дефолт http://10.0.2.2:8080/); Desktop — env SOTOSPEAK_API_BASE_URL (дефолт http://localhost:8080).
