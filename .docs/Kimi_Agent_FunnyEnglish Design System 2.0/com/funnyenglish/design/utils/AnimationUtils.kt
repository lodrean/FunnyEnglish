package com.funnyenglish.design.utils
...
fun easeInOutCubic(t: Float): Float {
    return if (t < 0.5f) {
        ...
        1 - kotlin.math.pow(-2 * t + 2, 3f) / 2
    }
}

@Stable
fun easeOutCubic(t: Float): Float {
    return 1 - kotlin.math.pow(1 - t, 3f)
}
...
@Stable
@Composable
fun <T> rememberAnimationValue(
    initialValue: T,
    targetValue: T,
    animationSpec: AnimationSpec<T>
): State<T> where T : androidx.compose.animation.core.AnimationVectorConverter<T> {
