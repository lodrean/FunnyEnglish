...
import com.sotospeak.entity.Lesson
...
@Repository
interface LearningPathRepository : JpaRepository<com.sotospeak.entity.LearningPath, UUID> {

    /**
     * Найти активный путь обучения
     */
    fun findByIsActiveTrue(): List<com.sotospeak.entity.LearningPath>

    /**
     * Найти первый активный путь (для использования по умолчанию)
     */
    fun findFirstByIsActiveTrue(): com.sotospeak.entity.LearningPath?
}

@Repository
interface PathLessonRepository : JpaRepository<com.sotospeak.entity.PathLesson, UUID> {

    /**
     * Найти уроки в пути по ID пути
     */
    fun findByLearningPathIdOrderByDisplayOrderAsc(pathId: UUID): List<com.sotospeak.entity.PathLesson>

    /**
     * Найти следующий урок в пути
     */
    fun findByLearningPathIdAndDisplayOrder(learningPathId: UUID, displayOrder: Int): com.sotospeak.entity.PathLesson?
}

@Repository
interface UserPathProgressRepository : JpaRepository<com.sotospeak.entity.UserPathProgress, UUID> {

    /**
     * Найти прогресс пользователя по пути
     */
    fun findByUserIdAndLearningPathId(userId: UUID, pathId: UUID): com.sotospeak.entity.UserPathProgress?

    /**
     * Найти все прогрессы пользователя
     */
    fun findByUserId(userId: UUID): List<com.sotospeak.entity.UserPathProgress>
    ...
    """)
    fun findActiveByUserId(@Param("userId") userId: UUID): com.sotospeak.entity.UserPathProgress?
}

@Repository
interface CompletedLessonRepository : JpaRepository<com.sotospeak.entity.CompletedLesson, UUID> {

    /**
     * Найти завершенные уроки пользователя
     */
    fun findByUserId(userId: UUID): List<com.sotospeak.entity.CompletedLesson>
     ...
     */
    fun findByUserIdAndLessonId(userId: UUID, lessonId: UUID): com.sotospeak.entity.CompletedLesson?
