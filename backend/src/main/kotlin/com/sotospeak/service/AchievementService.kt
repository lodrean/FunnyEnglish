...
import com.sotospeak.entity.AchievementEntity
...
class AchievementService(
    ...
    fun updateProgress(userId: UUID, achievementId: String, progress: Float) {
        ...
        if (userAchievement == null) {
            ...
            val newUserAchievement = com.sotospeak.entity.UserAchievementEntity(
                id = UUID.randomUUID(),
                userId = userId,
    ...
    private fun awardAchievement(userId: UUID, achievement: AchievementEntity) {
        val userAchievement = com.sotospeak.entity.UserAchievementEntity(
            id = UUID.randomUUID(),
            userId = userId,
