...
@Immutable
data class SoToSpeakColorScheme(
    ...
    val record: androidx.compose.ui.graphics.Color,
    val recordActive: androidx.compose.ui.graphics.Color,
    val recordShadow: androidx.compose.ui.graphics.Color,
    val waveformPlayback: androidx.compose.ui.graphics.Color,
    val statusNew: androidx.compose.ui.graphics.Color,
    val statusNewContainer: androidx.compose.ui.graphics.Color,
    val statusReviewed: androidx.compose.ui.graphics.Color,
    val statusReviewedContainer: androidx.compose.ui.graphics.Color,
    val timerLevel80: androidx.compose.ui.graphics.Color,
    val timerLevel50: androidx.compose.ui.graphics.Color,
    val timerLevel30: androidx.compose.ui.graphics.Color,
    val scrimSubtitle: androidx.compose.ui.graphics.Color,
    val scrimVideoControls: androidx.compose.ui.graphics.Color,
    val surfaceWarm: androidx.compose.ui.graphics.Color,
    val textMuted: androidx.compose.ui.graphics.Color
)

@Stable
private val LightExtendedColorScheme = SoToSpeakColorScheme(
    ...
    waveformPlayback = WaveformPlayback,
    statusNew = StatusNew,
    statusNewContainer = StatusNewContainer,
    statusReviewed = StatusReviewed,
    statusReviewedContainer = StatusReviewedContainer,
    timerLevel80 = TimerLevel80,
    timerLevel50 = TimerLevel50,
    timerLevel30 = TimerLevel30,
    scrimSubtitle = ScrimSubtitle,
    scrimVideoControls = ScrimVideoControls,
    surfaceWarm = SurfaceWarm,
    textMuted = TextMutedLight
)

@Stable
private val DarkExtendedColorScheme = SoToSpeakColorScheme(
    success = SuccessDark,
...
val LocalSoToSpeakColorScheme = staticCompositionLocalOf { LightExtendedColorScheme }
...
fun SoToSpeakTheme(
    ...
    CompositionLocalProvider(
        LocalSoToSpeakColorScheme provides extendedColorScheme
    ) {
        MaterialTheme(
...
object SoToSpeakTheme {
    val colors: SoToSpeakColorScheme
        @Composable
        get() = LocalSoToSpeakColorScheme.current
}
